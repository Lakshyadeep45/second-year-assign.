#include <bits/stdc++.h> // Name - Lakshyadeep
using namespace std;     // SID - 21107063  // Branch - Mechanical
...
int main()
{
    ...
    Add_Family_Member(Family_head,"GrandFather", 75);
    Add_Family_Member(Family_head, "GrandMother", 70);
    Add_Family_Member(Family_head, "Father", 55);
    Add_Family_Member(Family_head, "Mother", 53);
    Add_Family_Member(Family_head, "Brother", 21);
    Add_Family_Member(Family_head, "Me", 19);
